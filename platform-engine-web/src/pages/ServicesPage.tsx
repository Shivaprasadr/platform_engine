      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <p className="text-lg text-gray-600 mb-12 text-center max-w-3xl mx-auto">
            We provide comprehensive technology solutions to help your business scale and innovate. 
          ...
          <div className="space-y-16">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-8 border border-blue-200">
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">Cloud Technologies</h2>
                    <p className="text-lg text-gray-700 mb-6">
                      Transform your infrastructure with scalable cloud solutions. We specialize in AWS, Azure, and Google Cloud Platform 
                      to deliver reliable, cost-effective, and secure cloud environments.
                    </p>
            ...
            <div id="devops-solutions" className="scroll-mt-24">
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-8 border border-green-200">
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">DevOps Solutions</h2>
                    <p className="text-lg text-gray-700 mb-6">
                      Streamline your development lifecycle with comprehensive CI/CD pipelines and automation solutions. 
                      We accelerate delivery while maintaining quality and security standards.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
            ...
            <div id="tech-solutions-discovery" className="scroll-mt-24">
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-8 border border-purple-200">
                <div className="flex items-start gap-6">
                  <div className="w-20 h-20 bg-purple-500 rounded-xl flex items-center justify-center flex-shrink-0">
                    <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                    </svg>
                  </div>
                  <div className="flex-1">
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">Tech Solutions Discovery</h2>
                    <p className="text-lg text-gray-700 mb-6">
                      Strategic technology consulting and solution architecture to guide your digital transformation. 
                      We help identify opportunities and create roadmaps for sustainable growth.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
